...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.max_points = QtWidgets.QLabel(Dialog)
        font = QtGui.QFont()
        font.setFamily("Arial")
        self.max_points.setFont(font)
        self.max_points.setObjectName("max_points")
        self.horizontalLayout_4.addWidget(self.max_points)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_LCD.setText(_translate("Dialog", "<html><head/><body><p align=\"center\"><span style=\" font-size:36pt; font-weight:600;\">LCD</span></p></body></html>"))
        self.label_unit.setText(_translate("Dialog", "<html><head/><body><p><br/></p></body></html>"))
        self.label_4.setText(_translate("Dialog", "Max buffer points of graph:"))
        self.max_points.setText(_translate("Dialog", "5000"))
